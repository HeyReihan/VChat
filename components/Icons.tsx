...
export const HangUpIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-white"><path d="M3.63 2.27L2.36 3.54L5.6 6.77L4.22 8.14C4.06 8.29 4 8.5 4 8.71c0 .55.45 1 1 1 .16 0 .31-.05.45-.13l1.1-.55c.05-.03.11-.05.16-.09.39-.24.75-.56 1.16-.82l8.02 8.02.36.36c.15.14.36.24.57.24.55 0 1-.45 1-1 0-.16-.05-.31-.13-.45l-.55-1.1c-.04-.05-.07-.11-.11-.16-.24-.39-.56-.75-.82-1.16l4.39 4.39 1.27-1.27L3.63 2.27z"/></svg>
);
...
export const FlashOffIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
);
